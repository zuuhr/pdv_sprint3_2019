...
public class Pausa_minus13 : MonoBehaviour
{
    //VARIABLES
    Canvas canvas;//Canvas object
    public alien_movement_minus13 disableMovementAlien;//gameobject that refers to the aliens' movement
    ...
    void Start()
    {
        ...
        disableMovementAlien = GameObject.Find("Alien_Prefab").GetComponent<alien_movement_minus13>();//assign the alien prefab to the gameobject that refers to the aliens' movement
