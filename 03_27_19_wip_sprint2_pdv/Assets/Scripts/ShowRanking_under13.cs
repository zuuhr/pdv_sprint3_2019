...
public class ShowRanking_under13 : MonoBehaviour
{
    ...
    void Start()
    {
        for (int i = 0; i < 10; i++)
        {
            marcador = "nameu" + i;//to update the first key for accesing to another element of the playerprefs
            marcador2 = "scoresu" + i;//to update the second key
